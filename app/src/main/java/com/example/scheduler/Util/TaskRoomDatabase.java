...
import com.example.scheduler.Data.TaskDao;
...
public abstract class TaskRoomDatabase extends RoomDatabase {
    ...
    public static final String dbName="Scheduler_Database";
    ...
    public static TaskRoomDatabase getDatabase(final Context context){
        if(INSTANCE==null){
            synchronized (TaskRoomDatabase.class){
                if(INSTANCE==null){
                    INSTANCE= Room.databaseBuilder(context.getApplicationContext(),TaskRoomDatabase.class,dbName)
